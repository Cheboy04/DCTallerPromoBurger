...
namespace DCTallerPromoBurger.Controllers
{
    public class PromosController : Controller
    {
        private readonly DCTallerPromoBurgerContext _context;

        public PromosController(DCTallerPromoBurgerContext context)
        {
            _context = context;
        }
        ...
        {
            var dCTallerPromoBurgerContext = _context.Promo.Include(p => p.Burger);
            return View(await dCTallerPromoBurgerContext.ToListAsync());
        }
